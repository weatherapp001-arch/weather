...
import usePushNotifications from './firebase/hooks/usePushNotifications';
...
function App() {
    ...
    // New State for dynamic weather background (Requirement of new code)
    // iska bina kuch sho nahihota
    ...
    return (
        <div className={`full-screen-container ${weatherTheme} ${isDarkMode ? 'dark-theme' : ''}`}>
                ...
                <div className="app-body">
                    ...
                    <main className="view-port">
                        <section className="stats-section">
                            {activeTab === 'dashboard' && <Dashboard searchQuery={searchQuery} setWeatherTheme={setWeatherTheme} />}
                            {activeTab === 'cloud' && <Cloud searchQuery={searchQuery} setWeatherTheme={setWeatherTheme} />}
                            {activeTab === 'temperature' && <Temperature searchQuery={searchQuery} />}
                            {activeTab === 'calendar' && <Calendar searchQuery={searchQuery} />}
                            {/* AlertPanel is now inside the main section and only shows when activeTab is 'alert' */}
